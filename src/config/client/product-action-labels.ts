export const productActionLabels: Record<string, string> = {
  ...
  setup: "Einrichtung", setup_complete: "Einrichtung abschließen", app_open: "App geöffnet",
  browser_login: "Anmeldung (Browsermeldung)", browser_signup: "Registrierung (Browsermeldung)",
};
