            ...
            return (
              ...
              >
                <div className="flex min-h-6 items-center justify-between">
                  ...
                  {key === "team" && (
                    <span className="text-[10px] font-bold uppercase tracking-[0.14em] text-[#6658d3]">
                      Für viele passend
                    </span>
                  )}
                </div>
                ...
                <p className="mt-8 text-4xl font-semibold tracking-[-0.04em] text-slate-950">
                  {plan.priceEur ?? 0} €
                  <span className="ml-1 text-sm font-normal tracking-normal text-slate-500">
                    / Monat
                  </span>
                </p>
                ...
                <Link href="/register" className="mt-auto pt-8">
                  <Button
                    ...
                    className={`w-full rounded-none ${
                      key === "team"
                        ? "bg-slate-950 text-white hover:bg-[#6658d3]"
